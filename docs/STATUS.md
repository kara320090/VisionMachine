...
2026-09-22 최신 신청 결정: 기업연계형 신청, 구매 예상액 440,410원에 참여기업 회의비 59,590원을 편성하여 사용계획 500,000원. 이전 PDF 보고서의 59,590원 미배정 표기는 제작 당시 기록이며 현재 신청 예산과 다르다. 기업정보·협약서·사업자등록증은 이 공개 저장소에 넣지 않는다.

2026-09-23 공개 이미지 자료 검토: PlantVillage, PlantDoc, Mendeley Data의 정상·병해 자료와 이용조건을 1차 확인했다. 케일·깻잎 대체 후보로 가지·오이를 제안했으나 팀 결정 전이므로 후보 8종 고정 범위는 아직 바꾸지 않았다. 근거·다운로드 방법·적용 제한은 [DATASET_REVIEW](DATASET_REVIEW.md), 출처 상태는 `data/catalog/sources.csv`에 기록했다. 실제 원본 다운로드·파일 수·손상·중복·작물별 분포 검사는 아직 수행하지 않았다.
